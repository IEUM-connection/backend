...
-- MEMBER 데이터 삽입
INSERT INTO MEMBER (ADDRESS, ADMIN_NOTE, AGE, BIRTH_DATE, DETAILED_ADDRESS, DOCUMENT_ATTACHMENT, EMERGENCY_CONTACT, MEDICAL_HISTORY, MEMBER_CODE, MEMBER_STATUS, MILK_DELIVERY_REQUEST, NAME, NOTES, PHONE, PHONE_INACTIVE_DURATION, POSTAL_CODE, POWER_USAGE, RELATIONSHIP,  ROLE, TEL, X, Y, GUARDIAN_ID,ADMIN_NAME, ADMIN_PHONE)
VALUES ( '서울시 강남구', '고혈압 치료 중', 75, '1949-05-10', 'A동 101호', 'document1.pdf', '010-9876-5432', '고혈압', 'MEM001', 'ACTIVE', 'YES', '김철수', '매주 목요일 약 복용 확인', '010-1234-5678', 20, '06234', 180, '자녀', 'MEMBER', '02-1234-5678', '20.44654', '20.4564',  1, '박이연', '010-1111-2222');

INSERT INTO MEMBER ( ADDRESS, ADMIN_NOTE, AGE, BIRTH_DATE, DETAILED_ADDRESS, DOCUMENT_ATTACHMENT, EMERGENCY_CONTACT, MEDICAL_HISTORY, MEMBER_CODE, MEMBER_STATUS, MILK_DELIVERY_REQUEST, NAME, NOTES, PHONE, PHONE_INACTIVE_DURATION, POSTAL_CODE, POWER_USAGE, RELATIONSHIP,  ROLE, TEL,  X, Y, GUARDIAN_ID, ADMIN_NAME, ADMIN_PHONE)
VALUES ( '서울시 서초구', '당뇨 관리 중', 68, '1956-03-22', 'B동 202호', 'document2.pdf', '010-8765-4321', '당뇨', 'MEM002', 'ACTIVE', 'NO', '박영희', '간식 제한 필요', '010-2345-6789', 15, '06543', 150, '자녀',  'MEMBER', '02-2345-6789', '20.446546', '20.45646',2 ,  '황해진', '010-1111-2222');

INSERT INTO MEMBER ( ADDRESS, ADMIN_NOTE, AGE, BIRTH_DATE, DETAILED_ADDRESS, DOCUMENT_ATTACHMENT, EMERGENCY_CONTACT, MEDICAL_HISTORY, MEMBER_CODE, MEMBER_STATUS, MILK_DELIVERY_REQUEST, NAME, NOTES, PHONE, PHONE_INACTIVE_DURATION, POSTAL_CODE, POWER_USAGE, RELATIONSHIP,  ROLE, TEL,  X, Y, GUARDIAN_ID, ADMIN_NAME, ADMIN_PHONE)
VALUES ( '서울시 송파구', '심장 약 복용 중', 72, '1952-08-11', 'C동 303호', 'document3.pdf', '010-7654-3210', '심장 질환', 'MEM003', 'ACTIVE', 'YES', '이민수', '주말에만 운동 가능', '010-3456-7890', 25, '13894', 170, '친척',  'MEMBER', '02-3456-7890', '20.44654', '20.45646',3,  '옥성민', '010-1111-2222');

INSERT INTO MEMBER ( ADDRESS, ADMIN_NOTE, AGE, BIRTH_DATE, DETAILED_ADDRESS, DOCUMENT_ATTACHMENT, EMERGENCY_CONTACT, MEDICAL_HISTORY, MEMBER_CODE, MEMBER_STATUS, MILK_DELIVERY_REQUEST, NAME, NOTES, PHONE, PHONE_INACTIVE_DURATION, POSTAL_CODE, POWER_USAGE, RELATIONSHIP,  ROLE, TEL,  X, Y, GUARDIAN_ID, ADMIN_NAME, ADMIN_PHONE)
VALUES ( '서울시 광진구', '허리디스크 치료 중', 70, '1954-12-25', 'D동 404호', 'document4.pdf', '010-6543-2109', '허리디스크', 'MEM004', 'ACTIVE', 'NO', '최명숙', '조심스러운 움직임 필요', '010-4567-8901', 10, '04994', 190, '자녀',  'MEMBER', '02-4567-8901', '20.446546', '20.4564',4,  '김찬준', '010-1111-2222');

INSERT INTO MEMBER ( ADDRESS, ADMIN_NOTE, AGE, BIRTH_DATE, DETAILED_ADDRESS, DOCUMENT_ATTACHMENT, EMERGENCY_CONTACT, MEDICAL_HISTORY, MEMBER_CODE, MEMBER_STATUS, MILK_DELIVERY_REQUEST, NAME, NOTES, PHONE, PHONE_INACTIVE_DURATION, POSTAL_CODE, POWER_USAGE, RELATIONSHIP,  ROLE, TEL,  X, Y, GUARDIAN_ID, ADMIN_NAME, ADMIN_PHONE)
VALUES ( '서울시 마포구', '치매 초기 증상', 66, '1958-11-15', 'E동 505호', 'document5.pdf', '010-5432-1098', '치매', 'MEM005', 'ACTIVE', 'YES', '정우성', '자주 잊어버림, 확인 필요', '010-5678-9012', 30, '04084', 210, '자녀',  'MEMBER', '02-5678-9012','20.446546', '20.45646', 5,  '윤영아', '010-1111-2222');
