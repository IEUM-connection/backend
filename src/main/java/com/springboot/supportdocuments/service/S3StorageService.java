...
@Slf4j
public class S3StorageService implements DocumentService {
    private static final String BUCKET_NAME = "modooon";
    private static final String BUCKET_PATH = "supportdocument";
    ...
    public String store(MultipartFile multipartFile) {
        ...
        // S3 object의 키를 만든다.
        String key = makeS3OBjectKey(BUCKET_PATH, filename);
...
//            s3Client.close();
    ...
    private String makeS3OBjectKey(String bucketCoffeeImagePath, String filename) {
        return BUCKET_PATH.concat("/").concat(filename);
    }
