          ...
          .headers().frameOptions().sameOrigin() // H2 Console 사용 시 필요
               .and()
                ...
                .authorizeRequests(authorize -> authorize
                        ...
                        .antMatchers(HttpMethod.POST,"/guardians/check-email").permitAll()
...
//        return source;
        ...
        configuration.setAllowedHeaders(Arrays.asList("Authorization", "Cache-Control", "Content-Type", "loginType"));
